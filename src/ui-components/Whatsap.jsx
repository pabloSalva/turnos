...
export default function Whatsap(props) {
  ...
  const variants = [
    {
      overrides: {
        "View.Flex[0].Text[0]": {},
        "View.Flex[0]": {},
        "View.Flex[1].Flex[0].Icon[0]": {},
        "View.Flex[1].Flex[0].Icon[1]": {},
        "View.Flex[1].Flex[0]": {},
        "View.Flex[1]": {},
        View: {},
      },
      variantValues: { property1: "cargado" },
    },
    {
      overrides: {
        "View.Flex[0]": {
          left: "54.06976744186046%",
          right: "27.325581395348834%",
        },
        "View.Flex[1].Flex[0].Icon[0]": {},
        "View.Flex[1].Flex[0].Icon[1]": {},
        "View.Flex[1].Flex[0]": {},
      ...
      variantValues: { property1: "sin datos" },
    },
  ];
      ...
      >
        ...
        >
          ...
          <Icon
            ...
            left="0%"
            right="0%"
            {...getOverrideProps(overrides, "View.Flex[1].Flex[0].Icon[1]")}
          ></Icon>
        </Flex>
      </Flex>
    </View>
